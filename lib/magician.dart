              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: const TextStyle(color: Color.fromARGB(198, 204, 132, 24)),
                  )
                ],
              ),
...
class MagicianPage extends StatelessWidget {
  ...
  final List<Magician> magicians = const [
    Magician(
      ...
      [
        Magic('完全記憶能力',
            '茵蒂克絲擁有完全記憶能力的特異體質，不管是每棵行道樹的葉子、行人的臉或每顆雨滴的形狀…任何東西，無論多麼複雜的事物，只要看過一次就會全部記住不會遺忘，也能夠將記憶妥善區別保存。茵蒂克絲還能做到重拾被一瞬間破壞的、無數碎片般的情報然後在腦中組成真正的圖像文字符串、將每秒30幀的畫面或60幀的動作遊戲一幀一幀記錄下來然後瞬間檢索分析這種事情。'),
        Magic('龍王的嘆息',
            '與傳說中聖喬治之龍的一擊具有相同意義的魔法。茵蒂克絲發動聖喬治聖域產生的漆黑龜裂深處發出的直徑約一公尺的白色光束，質量之大讓幻想殺手也不足以完全消除，幻想殺手的處理能力趕不上其魔法的速度，甚至能夠一點一點侵蝕上條的右手。最大射程不明，被「龍王的嘆息」破壞的部分會變成潔白的發光羽毛，普通人只要輕輕觸碰任何一根羽毛都會對肉體造成極大的傷害。'),
        Magic('聖喬治聖域',
            '自動書記模式下發動的對抗單體侵入者最有效的魔法。發動時茵蒂克絲雙眼中的兩個魔法陣一口氣擴大，形成兩個交迭在一起的直徑兩公尺多的魔法陣，如同分別被固定在兩顆眼球上，浮在空中的魔法陣會跟著茵蒂克絲的腦袋移動。以兩個魔法陣的接點（靠近眉心的位置）為中心，朝四面八方產生漆黑的龜裂，延伸到房間各個角落，彷彿一道防壁，阻止任何人靠近茵蒂克絲。'),
      ],
    ),
    Magician(
      '史提爾·馬格努斯',
    ...
    Magician(
      ...
      [
        ...
        Magic('唯閃', '七天七刀一擊必殺的拔刀術。對特定宗教迂迴使出其他教義的術式攻擊。十字教的術式不行的話就用佛教術式，佛教術式不行的話就用神道術式，神道術式不行的話就用十字教術式，像這樣藉由適當互補彼此的弱點，發揮出完全破壞力的獨一無二攻擊式是「唯閃」。理論上，「唯閃」可以將一神教天使一刀結果。當然，「唯閃」發動時，神裂被強行引出的威力，會超過肉體能操縱的運動量，所以不可能在這種狀態下長時間進行戰鬥。正因如此，神裂的「唯閃」才要淬煉成一發就能決勝負的拔刀術。「唯閃」是天草式歷史的結晶。雖然天草式的同伴們無法使用「唯閃」，但是，這招的基礎劍術、鋼絲、術式，它的組合與戰術模式，全都是天草式的前輩們教給神裂的。'),
